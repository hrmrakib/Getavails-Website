    ...
    <section className='py-16 px-4 bg-gray-50'>
      <div className='container mx-auto'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-[#6B7280] max-w-[593px] mx-auto leading-relaxed'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className='bg-white rounded-lg border border-[#235789] p-6 hover:shadow-md transition-shadow duration-200'
              >
                <div className='flex items-center gap-3 mb-4'>
                  <div className='flex-shrink-0'>
                    <IconComponent className='h-6 w-6 text-[#235789]' />
                  </div>
                  <h3 className='font-semibold text-[#235789] text-lg'>
                    {feature.title}
                  </h3>
                </div>
