...
const BlogHeroContent = () => {
  ...
  return (
    <div>
      <div className='z-10 -mt-56 grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 container mx-auto px-6'>
        <Card
          className={`bg-[#F6FBFF] rounded-2xl !border-none overflow-hidden cursor-pointer transition-all duration-300 ${
