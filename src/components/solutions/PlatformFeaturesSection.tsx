    ...
    <section className='py-16 px-4 bg-white'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-[#6B7280]0 text-lg max-w-3xl mx-auto text-pretty'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          {features.map((feature, index) => (
            <div
              key={index}
              className={`p-6 rounded-lg transition-all duration-300 hover:shadow-lg !border !border-[#235789] ${
                feature.highlighted
            ...
            >
              <h3
                className={`text-lg font-semibold mb-4 text-balance ${
                  feature.highlighted ? "text-white" : "text-[#235789]"
                }`}
              >
                {feature.title}
              </h3>
              <p
                className={`text-sm leading-relaxed text-pretty ${
                  feature.highlighted ? "text-blue-100" : "text-[#6B7280]"
                }`}
              >
                {feature.description}
              </p>
