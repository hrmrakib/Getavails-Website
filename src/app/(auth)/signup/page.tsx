...
const journeys = [
  ...
  },
  {
    ...
    icon: User,
    details: [
      "Manage multiple artist calendars and availability",
      "Negotiate deals and performance terms",
      "Coordinate contracts with venues and organizers",
      "Track bookings, commissions, and revenue",
    ],
  ...
  },
  {
    ...
    details: [
      ...
      "Set availability, rates, and tour preferences",
      "Receive, accept, or decline booking requests",
      "Track past performances and earnings",
    ],
    buttonText: "Join as Artist",
  },
  {
    id: "tour-manager",
    title: "Tour Manager Journey:",
    icon: Building,
    details: [
      "Plan and manage multi-city tour schedules",
      "Coordinate logistics, travel, and accommodations",
      "Oversee show confirmations and timelines",
      "Ensure smooth communication between artists, agents, and venues",
    ],
    buttonText: "Join as Tour Manager",
  },
  {
    id: "venue",
    title: "Venue Journey:",
    icon: Building,
    details: [
      "Create and manage venue listings with capacity and tech specs",
      "Publish available dates and booking requirements",
      "Coordinate event schedules and load-in details",
      "Handle contracts, payouts, and post-event reports",
    ],
  ...
  },
  {
    ...
    icon: Building2,
    details: [
      "Plan and manage concerts, festivals, and live events",
      "Book artists and coordinate with venues",
      "Oversee event timelines, promotion, and staffing",
      "Manage budgets, contracts, and overall execution",
    ],
