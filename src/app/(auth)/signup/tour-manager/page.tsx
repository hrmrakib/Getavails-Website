...
export default function SignUpFormForTourManager() {
  ...
  const [tourManagerRegisterMutation] = useTourManagerRegisterMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await tourManagerRegisterMutation(data).unwrap();
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-2'>
              <h1 className='text-2xl font-bold text-foreground'>
                Start Your Journey as an Tour Manager.
              </h1>
              <p className='text-muted-foreground text-sm'>
                Join as an Tour Manager with our all-in-one booking system.
              </p>
            </div>
