...
import { BookingModal } from "@/components/agent/BookingModal";
import { AddArtistModal } from "@/components/agent/AddArtistModal";
    ...
    <div className='min-h-screen bg-background'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <div className='flex items-center gap-2'>
            <Avatar className='h-8 w-8'>
              <AvatarImage src='/placeholder-30u2g.png' alt='Steven Yuen' />
              <AvatarFallback>SY</AvatarFallback>
            </Avatar>
            <div className='hidden md:block'>
              <p className='text-sm font-medium'>Steven Yuen</p>
      ...
      <div className='px-4 md:px-6'>
        <div className='bg-card rounded-lg border border-border overflow-hidden'>
          ...
          <div className='hidden md:grid md:grid-cols-6 bg-primary text-primary-foreground p-4 font-medium'>
            <div>Artist</div>
            <div>Genre</div>
            <div>Location</div>
